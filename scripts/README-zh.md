...
### 第 5 步：可选 - 添加顶部 badges 和统计信息

你可以参考示例中的样式，在入口 README 中添加项目统计信息：
...
[![GitHub Stars](https://img.shields.io/github/stars/laychic/claude-explain-pane)](https://github.com/laychic/claude-explain-pane/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/laychic/claude-explain-pane)](https://github.com/laychic/claude-explain-pane/network)
